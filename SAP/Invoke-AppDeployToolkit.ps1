...
$adtSession = @{
    ...
    AppScriptDate = '2025-04-02'
    AppScriptAuthor = 'INTERCOS'

    # Install Titles (Only set here to override defaults set by the toolkit).
    InstallName = 'Installazione SAP 8'
    InstallTitle = 'Installazione SAP 8'
...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -CloseProcesses @{ Name = 'saplogon' } -BlockExecution -AllowDefer -DeferTimes 3 -PersistPrompt
    ...
    Start-ADTProcess -FilePath "$($adtSession.dirFiles)\Win32\Setup\NwsapSetup.exe" -ArgumentList '/product:"SAPGUI" /Silent' -PassThru -IgnoreExitCodes *
    Start-ADTProcess -FilePath "$($adtSession.dirFiles)\Patch\GUI800_11-80006341.EXE" -ArgumentList '/product:"SAPGUI" /Silent' -PassThru -IgnoreExitCodes *
    ...
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message 'Installazione di SAP 8 completata con successo' -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
